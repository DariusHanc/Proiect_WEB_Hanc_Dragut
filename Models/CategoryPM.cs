...
namespace Proiect_Dragut_Hanc.Models
{
    public class ProductCategoriesPM : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Proiect_Dragut_HancContext context, Product product)
        {
        ...
        public void UpdateProductCategories(Proiect_Dragut_HancContext context, string[] selectedCategories, Product productToUpdate)
        {
